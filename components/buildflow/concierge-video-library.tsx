...
export function ConciergeVideoLibrary() {
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.storyBand}><div className={styles.sectionHeading}><p className={styles.eyebrow}>Choose your contractor story</p><h2>Built for the way jobs actually move.</h2></div><div className={styles.storySelector}><StoryVideo story={stories.crew} /><StoryVideo story={stories.cost} /></div></section>

      <SplitSection eyebrow="Price and quantity visibility" title="What did the material actually cost?" body="When labor and material arrive as one number, it can be difficult to understand the material cost. Send the quote, plan, or material list. We can help check quantities, price the material separately, and provide another option before approval." image="/images/buildflow-retail/orders.jpg" reverse><p className={styles.callout}>Keep your sub. Keep your supplier.<br />Use Avantia wherever you need clarity.</p></SplitSection>
      ...
      <section className={styles.categories}><div className={styles.sectionHeading}><p className={styles.eyebrow}>Across the entire project</p><h2>One desk. Every material category.</h2></div><div className={styles.categoryGrid}>{[
        ["Framing", "/images/buildflow-retail/framing-materials-yard.webp"], ["Roofing & siding", "/images/buildflow-retail/roofing-department.webp"], ["Windows", "/images/buildflow-retail/windows-department.webp"], ["HVAC & mechanical", "/images/buildflow-retail/roughIn.jpg"], ["Electrical", "/images/buildflow-retail/electrical-department-cutout-v2.webp"], ["Sheet Rock", "/images/buildflow-retail/drywall-department.webp"], ["Tile & stone", "/images/buildflow-retail/tile-department.webp"], ["Flooring", "/images/buildflow-retail/flooring-department.webp"], ["Doors & molding", "/images/buildflow-retail/door-molding-department.webp"], ["Special items", "/images/buildflow-retail/uploads.jpg"],
