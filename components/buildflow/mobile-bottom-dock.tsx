...
function DockItem({
  ...
  return (
    <Link
      ...
      prefetch={false}
      aria-label={label}
      className={`group relative flex min-h-11 min-w-0 ${accent ? "flex-[1.28]" : "flex-1"} flex-col items-center justify-center rounded-[18px] px-1 py-1.5 text-center transition-[transform,color,background-color,box-shadow] duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 active:scale-[0.96] ${active ? "bg-[linear-gradient(180deg,rgba(255,255,255,0.4),rgba(255,255,255,0.16))] text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.58),inset_0_-8px_14px_rgba(255,255,255,0.06),0_8px_18px_rgba(148,163,184,0.1)]" : "text-slate-500/95"}`}
    >
      <span
        className={`relative flex items-center justify-center overflow-hidden transition-[transform,width,height,background-color,color] duration-200 ease-out group-active:translate-y-[1px] ${
          accent
