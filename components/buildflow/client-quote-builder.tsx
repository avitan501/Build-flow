        ...
        <div className="fixed inset-0 z-[100] grid place-items-center overflow-y-auto bg-slate-950/60 p-4" role="dialog" aria-modal="true" aria-labelledby="client-preview-title">
          <div className="my-8 w-full max-w-3xl overflow-hidden rounded-xl bg-white shadow-2xl">
            ...
            <div className="p-5 sm:p-8">
              ...
              <div className="mt-7 flex flex-col gap-3 border-t border-slate-200 pt-5 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between"><span>Avantia Build · (516) 908-8319 · office@build.avantiap.com</span><span className="inline-flex items-center gap-1 font-bold text-[#0066cc]">avantiabuild.com <ArrowRight className="h-3.5 w-3.5" /></span></div>
            </div>
