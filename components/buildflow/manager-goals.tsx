...
export function CustomManagerGoals({ goals }: { goals: ManagerGoalRecord[] }) {
  ...
  return <div className="mt-3 overflow-hidden rounded-md border border-slate-200 bg-white">
    {activeGoals.map(goalRow)}
    {!activeGoals.length ? <p className="px-3 py-4 text-center text-xs text-slate-500">No active custom goals.</p> : null}
