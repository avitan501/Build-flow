...
export function ConstructionConciergeHome() {
  ...
  return (
    <main className="overflow-x-clip bg-[#f4f5f7] text-[#071126]">
      <section data-homepage-hero className="relative isolate flex min-h-[min(88svh,58rem)] items-start justify-center overflow-hidden bg-[#071126] text-white sm:aspect-video sm:min-h-0 sm:items-center">
