...
export function DepartmentRequestComposer({ category, displayCategory = category, requestId, questionnaireDepartment }: { category: string; displayCategory?: string; requestId: string; questionnaireDepartment?: string }) {
