    ...
    <ShopTranslationBoundary><section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
      ...
      {allowsReferencePhoto && hasReferenceSelection ? <div className="grid gap-3 border-t border-slate-200 bg-slate-50 px-4 py-4 sm:grid-cols-[1fr_auto] sm:items-center sm:px-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <a href="https://www.gardenstatelumber.com/products-programs/moulding/" target="_blank" rel="noopener noreferrer" aria-label="Open the Garden State Lumber molding catalog in a new tab" className="inline-flex min-h-11 items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 text-sm font-semibold text-slate-700">Garden State Lumber catalog<ExternalLink className="h-4 w-4" aria-hidden="true" /></a>
