      ...
      <div className="mx-auto grid max-w-6xl items-center gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:gap-16">
        ...
        >
          <div className="relative aspect-[4/5] overflow-hidden rounded-[1.55rem] bg-slate-900 sm:aspect-[16/10]">
            <video key={videoInView ? "playing" : "poster"} autoPlay muted loop playsInline preload="none" poster="/images/buildflow-homepage/process-text-request-v6.webp" className="h-full w-full object-cover object-center" aria-label="A contractor texts a same-day material list and receives the delivery at the jobsite">
              {videoInView ? <source src="/videos/homepage-material-process-v2.mp4" type="video/mp4" /> : null}
            </video>
