...
export type ReceivedSupplierQuote = { id: string; supplierName?: string; fileName: string; sourceUrl?: string | null; sourceItems?: ReceivedSupplierQuoteLine[]; inComparison?: boolean; duplicateKey?:string; proposalTotal?:{amount:number|null;basis:'document-subtotal'|'source-lines'|'unavailable';discrepancy:boolean} }
