export type ReceivedSupplierQuoteLine = { line_number: number; description: string; specification: string | null; quantity: number; unit: string; unit_price: number; line_total: number }
