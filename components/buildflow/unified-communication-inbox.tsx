...
export function UnifiedCommunicationInbox({ communications, contacts, customers, leads = [], suppliers = [], materialRequests = [], connections, initialChannelFilter = "all", initialQuery = "" }: {
  ...
  return <section className="h-full min-h-0 w-full max-w-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm" aria-label="Unified communications inbox">
