...
export function QuoteMatchReview({ quote, request, lines, notes }: { quote: ReceivedSupplierQuote; request: string; lines: ReceivedSupplierQuoteLine[]; notes: string[] }) {
