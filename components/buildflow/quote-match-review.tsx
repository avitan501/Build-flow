...
export function QuoteMatchReview({ quote, request, originalRequest, lines, notes }: { quote: ReceivedSupplierQuote; request: string; originalRequest?:string; lines: ReceivedSupplierQuoteLine[]; notes: string[] }) {
