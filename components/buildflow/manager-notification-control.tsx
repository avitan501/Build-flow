...
export function ManagerNotificationControl() {
  ...
  return <>
    <button type="button" onClick={() => setOpen(true)} className="inline-flex min-h-10 items-center gap-2 rounded-md border border-slate-200 bg-white px-3 text-xs font-semibold text-slate-800 shadow-sm hover:border-sky-300" aria-label="Phone notification settings"><Bell className="h-4 w-4 text-[#0071e3]" />Notifications</button>
