...
test("rejects quantities and unsupported values presented as thickness", () => {
  ...
  expect(verifiedThickness("1-3/4 in", "2 pc 1-3/4x10 LVL 18 ft")).toBe("1-3/4 in")
  expect(verifiedThickness("1-3/4 in", "4 pc 1-3/4x11-1/4 LVL by 24 ft")).toBe("1-3/4 in")
  expect(verifiedThickness("1-3/4 in", "6 pc 10 in LVL 20 ft")).toBe("")
