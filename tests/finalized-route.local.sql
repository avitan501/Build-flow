...
create function private.is_admin() returns boolean language sql as $$select true$$;
create function private.has_staff_capability(text) returns boolean language sql as $$select true$$;
