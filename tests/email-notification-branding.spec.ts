...
test("customer email chrome includes the animated logo and every company contact method", () => {
  ...
  expect(html).toContain("mailto:office@avantiabuild.com")
  expect(html).toContain("tel:+15169901990")
  expect(html).toContain("https://wa.me/15169901990")
  expect(html).toContain("(516) 990-1990")
})
...
test("cart confirmation sent to the client includes the requested item list and contact footer", async () => {
  ...
  expect(clientDelivery?.html).toContain("office@avantiabuild.com")
  expect(clientDelivery?.html).toContain("(516) 990-1990")
