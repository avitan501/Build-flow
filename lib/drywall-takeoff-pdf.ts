...
function buildPageContent(input: DrywallTakeoffPdfInput) {
  ...
  lines.push("0.2 w");
  lines.push(textLine(48, 760, 20, "BUILDFLOW"));
  ...
  lines.push(textLine(48, 30, 8, "Generated by BuildFlow. Verify field dimensions, board rating, and local code before ordering."));
  return lines.join("\n");
}
