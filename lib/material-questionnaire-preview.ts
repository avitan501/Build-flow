...
export const DRYWALL_QUESTIONNAIRE_PREVIEW: MaterialQuestionnaireSnapshot = {
  ...
  questions: [
    ...
    drywallQuestion({ id: "needs-compound", question_key: "needs_compound", label: "Do you need joint compound / spackle?", question_type: "yes_no", sort_order: 150, configuration: { imageUrl: "/images/department-essentials/drywall-grid.webp", imagePosition: "66.667% 0%", imageSprite: true } }),
    ...
    drywallQuestion({ id: "needs-tape", question_key: "needs_tape", label: "Do you need drywall tape?", question_type: "yes_no", sort_order: 220, configuration: { imageUrl: "/images/department-essentials/drywall-grid.webp", imagePosition: "100% 0%", imageSprite: true } }),
