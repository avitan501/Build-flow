...
export const DOOR_MOLDING_QUESTIONNAIRE_PREVIEW: MaterialQuestionnaireSnapshot = {
  ...
  questions: [
    ...
    doorQuestion({ id: "door-quality-level", question_key: "quality_level", label: "What quality level do you need?", question_type: "single_select", sort_order: 67, conditional_parent_question_id: "door-request-type", conditional_operator: "includes_any", conditional_value: ["door"], options: options("door-quality-level", [["Standard", "standard"], ["High-End", "high-end"], ["Custom / not sure", "custom"]]) }),
