...
const MANAGER_PAGE_SEARCH_ITEMS: ManagerPageSearchItem[] = [
  ...
  { id: "renovation-ai", title: "Renovation AI", description: "Build a material-only apartment renovation budget", href: "/admin/ai-tools/renovation-estimator", category: "Page", keywords: "renovation apartment estimate budget calculator", capability: "aiTools" },
  { id: "share-ads", title: "Share Ads", description: "Approved flyers and advertising messages", href: "/admin/share-ads", category: "Page", keywords: "marketing flyer ad whatsapp share message campaign", ownerOnly: true },
  ...
  { id: "employee-browser", title: "Company screen", description: "Carlos work browser and live screen", href: "/admin/ai-tools/work-browser", category: "Page", keywords: "employee carlos browser live screen monitor", ownerOnly: true },
