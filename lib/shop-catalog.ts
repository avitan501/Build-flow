...
const PRODUCT_IMAGE_OVERRIDES_BY_SLUG: Record<string, ProductImageOverride> = {
  "galvanized-wire-mesh-27x96": { imageUrl: "/images/materials/tile-flyer/galvanized-metal-lath.jpg", imageAlt: "Galvanized wire mesh 27 by 96 inches", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "mapei-ultraflex-1-white-thinset-tile-mortar": { imageUrl: "/images/materials/tile-flyer/mapei-ultraflex-1.jpg", imageAlt: "MAPEI Ultraflex 1 white thinset 50 pound bag", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "cement-backer-board-3x5": { imageUrl: "/images/materials/tile-flyer/durock-cement-board.jpg", imageAlt: "Cement backer board 3 by 5 foot sheet", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "primer-plus-5-gallon": { imageUrl: "/images/materials/tile-flyer/primer-plus-5gal.png", imageAlt: "Primer Plus 5 gallon pail", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "hydro-ban-waterproofing-5-gallon": { imageUrl: "/images/materials/tile-flyer/hydro-ban-5-gal.jpg", imageAlt: "Hydro Ban waterproofing 5 gallon pail", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "portland-cement-type-i-ii-94lb": { imageUrl: "/images/materials/tile-flyer/portland-cement.jpg", imageAlt: "Portland cement Type I and II 94 pound bag", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "nxt-level-self-leveling-50lb": { imageUrl: "/images/materials/tile-flyer/nxt-level-50lb.png", imageAlt: "NXT Level self leveling underlayment 50 pound bag", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "strata-mat-uncoupling-membrane-54sqft": { imageUrl: "/images/materials/tile-flyer/strata-mat-54.png", imageAlt: "Strata Mat uncoupling membrane 54 square feet", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "fine-sand-50lb": { imageUrl: "/images/materials/tile-flyer/fine-sand.png", imageAlt: "Fine sand 50 pound bag", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "permacolor-grout-8lb": { imageUrl: "/images/materials/tile-flyer/permacolor-grout.png", imageAlt: "Permacolor grout 8 pound bag", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "laticrete-209-floor-mud-60lb": { imageUrl: "/images/materials/tile-flyer/laticrete-209-floor-mud.jpg", imageAlt: "Laticrete 209 Floor Mud 60 pound bag", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
  "premium-tile-mastic-1-gallon": { imageUrl: "/images/materials/tile-flyer/premium-mastic.png", imageAlt: "Premium tile mastic 1 gallon pail", imageCategory: "Tile", imageSource: "Owner-provided flyer asset", imageLicense: "Owner-provided asset", imageCredit: "Avantia Build" },
...
const PRODUCT_SEED_INPUTS = [
  ...
  {
    slug: "galvanized-wire-mesh-27x96",
    name: "Galvanized Wire Mesh",
    description: "Galvanized wire mesh for reinforced tile mortar-bed and mud-work assemblies.",
    shortDescription: "27 in. x 96 in. galvanized mesh sheet.",
    category: "Tile work",
    unit: "27 in. x 96 in. sheet",
    price: 12.99,
    supplierName: "Avantia Build flyer baseline",
    quoteNumber: "TILE-FLYER-001",
    specLine: "27 in. x 96 in. galvanized mesh",
    featuredLabel: "Mortar-bed prep",
    popularUse: "Tile substrate prep",
    reviewLabel: "Supplier price editable",
    rating: 4.7,
    relatedCategories: ["Tile work"],
  },
  {
    slug: "mapei-ultraflex-1-white-thinset-tile-mortar",
    name: "MAPEI Ultraflex 1 White Thinset",
    description: "White polymer-modified thinset mortar for ceramic, porcelain, and compatible natural-stone tile installations.",
    shortDescription: "MAPEI Ultraflex 1 white thinset, 50 lb.",
    category: "Tile work",
    unit: "50 lb. bag",
    price: 24.99,
    supplierName: "Avantia Build flyer baseline",
    quoteNumber: "TILE-FLYER-002",
    specLine: "White polymer-modified thinset - 50 lb.",
  ...
  {
    slug: "cement-backer-board-3x5",
    name: "Cement Backer Board",
    description: "Cement backer board for tile walls, floors, wet areas, and compatible substrate assemblies.",
    shortDescription: "3 ft. x 5 ft. cement backer board sheet.",
    category: "Tile work",
    unit: "3 ft. x 5 ft. sheet",
    price: 19.99,
    supplierName: "Avantia Build flyer baseline",
    quoteNumber: "TILE-FLYER-003",
    specLine: "Cement backer board - 3 ft. x 5 ft.",
  ...
  {
    slug: "primer-plus-5-gallon",
    name: "Primer Plus",
    description: "Primer for compatible self-leveling and tile-preparation systems.",
    shortDescription: "Primer Plus, 5 gallon pail.",
    category: "Tile work",
    unit: "5 gallon pail",
    price: 375,
    supplierName: "Avantia Build flyer baseline",
    quoteNumber: "TILE-FLYER-004",
    specLine: "Primer Plus - 5 gallons",
    featuredLabel: "Surface preparation",
    popularUse: "Leveler preparation",
    reviewLabel: "Supplier price editable",
    rating: 4.7,
    relatedCategories: ["Tile work"],
  },
  {
    slug: "hydro-ban-waterproofing-5-gallon",
    name: "Hydro Ban Waterproofing",
    description: "Liquid waterproofing membrane for compatible showers, wet areas, and tile assemblies.",
    shortDescription: "Hydro Ban waterproofing, 5 gallon pail.",
    category: "Tile work",
    unit: "5 gallon pail",
    price: 169,
    supplierName: "Avantia Build flyer baseline",
    quoteNumber: "TILE-FLYER-005",
    specLine: "Liquid waterproofing membrane - 5 gallons",
    featuredLabel: "Waterproofing",
    popularUse: "Wet-area tile systems",
    reviewLabel: "Supplier price editable",
    rating: 4.8,
    relatedCategories: ["Tile work"],
  },
  {
    slug: "portland-cement-type-i-ii-94lb",
    name: "Portland Cement Type I/II",
    description: "Type I/II Portland cement for tile prep mixes, mortar beds, and cement-based jobsite mixes.",
    shortDescription: "Type I/II Portland cement, 94 lb.",
    category: "Tile work",
    unit: "94 lb. bag",
    price: 18.99,
    supplierName: "Avantia Build flyer baseline",
    quoteNumber: "TILE-FLYER-006",
    specLine: "Portland cement Type I/II - 94 lb.",
  ...
  {
    slug: "nxt-level-self-leveling-50lb", name: "NXT Level Self Leveling", description: "Cement-based self-leveling underlayment for compatible interior floor-preparation systems.", shortDescription: "NXT Level self-leveling underlayment, 50 lb.", category: "Tile work", unit: "50 lb. bag", price: 28.75, supplierName: "Avantia Build flyer baseline", quoteNumber: "TILE-FLYER-007", specLine: "Self-leveling underlayment - 50 lb.", featuredLabel: "Floor preparation", popularUse: "Leveling substrates", reviewLabel: "Supplier price editable", rating: 4.7, relatedCategories: ["Tile work", "Flooring"],
  },
  {
    slug: "strata-mat-uncoupling-membrane-54sqft", name: "Strata Mat Uncoupling Membrane", description: "Uncoupling membrane for compatible tile floor assemblies.", shortDescription: "Strata Mat uncoupling membrane, 54 sq. ft.", category: "Tile work", unit: "54 sq. ft. roll", price: 99.99, supplierName: "Avantia Build flyer baseline", quoteNumber: "TILE-FLYER-008", specLine: "Uncoupling membrane - 54 sq. ft.", featuredLabel: "Uncoupling", popularUse: "Tile floor assemblies", reviewLabel: "Supplier price editable", rating: 4.8, relatedCategories: ["Tile work", "Flooring"],
  },
  {
    slug: "fine-sand-50lb", name: "Fine Sand", description: "Fine aggregate for tile preparation, mud work, leveling mixes, and mortar-bed assemblies.", shortDescription: "Fine sand, 50 lb. bag.", category: "Tile work", unit: "50 lb. bag", price: 6.49, supplierName: "Avantia Build flyer baseline", quoteNumber: "TILE-FLYER-009", specLine: "Fine sand - 50 lb.", featuredLabel: "Tile prep", popularUse: "Mud work", reviewLabel: "Supplier price editable", rating: 4.7, relatedCategories: ["Tile work", "Concrete"],
  },
  {
    slug: "permacolor-grout-8lb", name: "Permacolor Grout", description: "High-performance grout for compatible tile joints and installations.", shortDescription: "Permacolor grout, 8 lb. bag.", category: "Tile work", unit: "8 lb. bag", price: 24.75, supplierName: "Avantia Build flyer baseline", quoteNumber: "TILE-FLYER-010", specLine: "Permacolor grout - 8 lb.", featuredLabel: "Grout", popularUse: "Tile joints", reviewLabel: "Supplier price editable", rating: 4.8, relatedCategories: ["Tile work"],
  },
  {
    slug: "laticrete-209-floor-mud-60lb", name: "Laticrete 209 Floor Mud", description: "Factory-prepared floor mud for compatible mortar beds and tile substrate work.", shortDescription: "Laticrete 209 Floor Mud, 60 lb.", category: "Tile work", unit: "60 lb. bag", price: 13.75, supplierName: "Avantia Build flyer baseline", quoteNumber: "TILE-FLYER-011", specLine: "Floor mud - 60 lb.", featuredLabel: "Mortar bed", popularUse: "Tile floor prep", reviewLabel: "Supplier price editable", rating: 4.7, relatedCategories: ["Tile work", "Concrete"],
  },
  {
    slug: "premium-tile-mastic-1-gallon", name: "Premium Tile Mastic", description: "Premixed tile adhesive for compatible interior tile applications.", shortDescription: "Premium tile mastic, 1 gallon.", category: "Tile work", unit: "1 gallon pail", price: 59.99, supplierName: "Avantia Build flyer baseline", quoteNumber: "TILE-FLYER-012", specLine: "Premixed tile mastic - 1 gallon", featuredLabel: "Tile adhesive", popularUse: "Interior wall tile", reviewLabel: "Supplier price editable", rating: 4.7, relatedCategories: ["Tile work"],
  },
  {
...
const TILE_FLYER_BULK_PRICES: Record<string, { bulkPrice: number; bulkMinimum: string }> = {
  "galvanized-wire-mesh-27x96": { bulkPrice: 10.99, bulkMinimum: "10+ sheets" },
  "mapei-ultraflex-1-white-thinset-tile-mortar": { bulkPrice: 21.99, bulkMinimum: "10+ bags" },
  "cement-backer-board-3x5": { bulkPrice: 17.99, bulkMinimum: "20+ sheets" },
  "primer-plus-5-gallon": { bulkPrice: 335, bulkMinimum: "4+ pails" },
  "hydro-ban-waterproofing-5-gallon": { bulkPrice: 149, bulkMinimum: "4+ pails" },
  "portland-cement-type-i-ii-94lb": { bulkPrice: 16.99, bulkMinimum: "20+ bags" },
  "nxt-level-self-leveling-50lb": { bulkPrice: 25.75, bulkMinimum: "10+ bags" },
  "strata-mat-uncoupling-membrane-54sqft": { bulkPrice: 90, bulkMinimum: "5+ rolls" },
  "fine-sand-50lb": { bulkPrice: 5.49, bulkMinimum: "20+ bags" },
  "permacolor-grout-8lb": { bulkPrice: 22.75, bulkMinimum: "10+ bags" },
  "laticrete-209-floor-mud-60lb": { bulkPrice: 12, bulkMinimum: "20+ bags" },
  "premium-tile-mastic-1-gallon": { bulkPrice: 55, bulkMinimum: "4+ pails" },
}
...
const SEEDED_SHOP_PRODUCTS: ShopCatalogProduct[] = PRODUCT_SEED_INPUTS.map((product, index) => {
  ...
  return {
    ...
    ...TILE_FLYER_BULK_PRICES[product.slug],
  }
})
...
const LIQUIDATION_MDF_PRODUCT: ShopCatalogProduct = {
  ...
  description: "Brand-new MDF sheets for cabinetry, furniture, shelving, wall panels, DIY projects, and woodworking. Price is $10 per board with a 20-board minimum order. Availability and pickup or delivery must be confirmed before purchase.",
...
export const APPLIANCE_RENTAL_PRODUCTS: ShopCatalogProduct[] = [
  {
    ...
    slug: "ge-30-inch-gas-range-jgbs30retss",
    name: "GE 30 in. Free-Standing Gas Range",
    description: "Rental-ready stainless steel gas range with four sealed burners, a 13,000 BTU burner, precise simmer control, a broiler drawer, and a 4.8 cu. ft. oven.",
    shortDescription: "Model JGBS30RETSS · 30 in. stainless steel gas range with four sealed burners and a 4.8 cu. ft. oven.",
    category: "Rentals",
    unit: "Each",
    price: 574,
    supplierName: "Avantia Build Appliances",
    quoteNumber: "JGBS30RETSS",
    image: "/images/materials/appliance-rentals/ge-jgbs30retss-front.jpg",
    imageUrl: "/images/materials/appliance-rentals/ge-jgbs30retss-front.jpg",
    imageAlt: "GE JGBS30RETSS stainless steel 30 inch gas range front view",
    imageSource: "https://www.geappliances.com/appliance/GE-30-Free-Standing-Gas-Range-JGBS30RETSS",
    imageLicense: "GE Appliances manufacturer product photo",
    imageCredit: "GE Appliances",
    imageCategory: "Appliances",
    gallery: [
      ["ge-jgbs30retss-front.jpg", "GE JGBS30RETSS gas range front view"],
      ["ge-jgbs30retss-angle.jpg", "GE JGBS30RETSS gas range with oven open and food arranged inside"],
      ["ge-jgbs30retss-cooktop.jpg", "GE JGBS30RETSS gas range with the oven door open"],
    ].map(([fileName, imageAlt]) => ({
      imageUrl: `/images/materials/appliance-rentals/${fileName}`,
      imageAlt,
      imageSource: "https://www.geappliances.com/appliance/GE-30-Free-Standing-Gas-Range-JGBS30RETSS",
      imageLicense: "GE Appliances manufacturer product photo",
      imageCredit: "GE Appliances",
    ...
    specLine: "Model JGBS30RETSS - 30 in. W x 46.25 in. H x 28.75 in. D",
    availability: "Confirm current availability",
    featuredLabel: "Rental appliance",
    popularUse: "Apartments and rental properties",
    reviewLabel: "Invoice-priced item",
    rating: 4.8,
    relatedCategories: ["Rentals", "Kitchen"],
    productType: "material",
    detailBullets: [
      "Model JGBS30RETSS",
      "Natural gas with an included LP conversion kit",
      "Four sealed burners and 4.8 cu. ft. oven capacity",
      "Invoice price shown per appliance; delivery and tax are calculated separately",
    ],
  },
  {
    id: "rental-appliance-frigidaire-ffht1835vs",
    slug: "frigidaire-18-3-cu-ft-top-freezer-refrigerator-ffht1835vs",
    name: "Frigidaire 18.3 Cu. Ft. Top Freezer Refrigerator",
    description: "Rental-ready 30 in. stainless steel refrigerator with an 18.3 cu. ft. capacity, EvenTemp cooling, adjustable glass shelves, humidity-controlled crispers, and reversible doors.",
    shortDescription: "Model FFHT1835VS · 30 in. stainless steel top-freezer refrigerator with 18.3 cu. ft. capacity.",
    category: "Rentals",
    unit: "Each",
    price: 624,
    supplierName: "Avantia Build Appliances",
    quoteNumber: "FFHT1835VS",
    image: "/images/materials/appliance-rentals/frigidaire-ffht1835vs-front.jpg",
    imageUrl: "/images/materials/appliance-rentals/frigidaire-ffht1835vs-front.jpg",
    imageAlt: "Frigidaire FFHT1835VS stainless steel top freezer refrigerator front view",
    imageSource: "https://www.frigidaire.ca/Owner-Centre/Product-Support/FFHT1835VS",
    imageLicense: "Frigidaire manufacturer product photo distributed by an authorized retailer",
    imageCredit: "Frigidaire",
    imageCategory: "Appliances",
    gallery: [
      ["frigidaire-ffht1835vs-front.jpg", "Frigidaire FFHT1835VS refrigerator front view"],
      ["frigidaire-ffht1835vs-open.jpg", "Frigidaire FFHT1835VS refrigerator open interior view"],
      ["frigidaire-ffht1835vs-storage.jpg", "Frigidaire FFHT1835VS refrigerator filled storage view"],
    ].map(([fileName, imageAlt]) => ({
      imageUrl: `/images/materials/appliance-rentals/${fileName}`,
      imageAlt,
      imageSource: "https://www.frigidaire.ca/Owner-Centre/Product-Support/FFHT1835VS",
    ...
    specLine: "Model FFHT1835VS - 30 in. W x 66.375 in. H x 30.375 in. D",
    availability: "Confirm current availability",
    featuredLabel: "Rental appliance",
    popularUse: "Apartments and rental properties",
    reviewLabel: "Invoice-priced item",
    ...
    detailBullets: [
      "Model FFHT1835VS",
      "18.3 cu. ft. total capacity with top freezer",
      "ENERGY STAR certified, garage ready, and ice-maker ready",
      "Invoice price shown per appliance; delivery and tax are calculated separately",
    ],
  },
]
...
export function normalizeShopItems(items: ShopItemRecord[]): ShopCatalogProduct[] {
  return items.map((item, index) => {
    ...
    return {
      ...
      supplierName: mappedCategory === "Liquidation" ? "Avantia Build Liquidation" : item.supplier_name,
      quoteNumber: mappedCategory === "Liquidation" ? null : item.quote_number,
      image: image.imageUrl,
      imageUrl: image.imageUrl,
      imageAlt: image.imageAlt,
      imageSource: image.imageSource,
