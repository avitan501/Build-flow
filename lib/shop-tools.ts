...
export const SHOP_TOOL_CATEGORIES: ShopToolCategory[] = [
  ...
  },
  {
    ...
    imageUrl: "/images/buildflow-retail/framing-materials-yard.webp",
  ...
  },
  {
    ...
    imageAlt: "Tile displays in a building supply showroom",
  ...
  },
  {
    ...
    imageAlt: "Sheetrock and drywall materials in a supply store",
  ...
  },
  {
    ...
    imageAlt: "Doors, windows, and molding displays",
    symbols: ["shopping-list", "blueprint", "delivery"],
  },
  {
    slug: "wood-floor",
    ...
    imageUrl: "/images/buildflow-retail/wood-floor-department.png",
    imageAlt: "Wood finish and flooring showroom displays",
  ...
  },
  {
    ...
    imageUrl: "/images/buildflow-retail/siding-department.png",
    imageAlt: "Exterior building materials at a supply yard",
    symbols: ["shopping-list", "blueprint", "site-visit"],
  },
  {
    slug: "roofing",
    ...
    imageAlt: "Roof shingles and roofing materials at a supply yard",
    symbols: ["shopping-list", "blueprint", "site-visit"],
  },
  {
    slug: "window",
    ...
    imageAlt: "Window and door displays in a building supply store",
    symbols: ["shopping-list", "blueprint", "site-visit"],
  },
]
