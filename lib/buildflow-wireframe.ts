  ...
  const specs: RouteSpec[] = [
    {
      ...
      href: "/",
      title: "Home",
      purpose: "Public entry screen for the Avantia Build client journey.",
      flow: "client",
      audience: "public",
      category: "Foundation",
      ...
      missing: ["Project start handoff", "Upload route clarity", "Order tracking context"],
      actions: [
    ...
    },
    {
      ...
      href: "/dashboard",
      title: "Dashboard",
      purpose: "Signed-in command center for the active Avantia Build client journey.",
      flow: "client",
      audience: "signed_in",
      category: "Auth",
      status: auth.status,
    ...
    },
    {
      ...
      nextStep: "Keep WhatsApp operations admin-only while draft actions stay non-sending.",
      missing: [
    ...
    },
    {
      ...
      purpose: "Protected admin-only preview settings screen for safe WhatsApp behavior rules.",
      flow: "whatsapp",
      audience: "admin",
      category: "WhatsApp",
    ...
    },
    {
      ...
      title: "Build Map",
      purpose: "Main clickable map of the Avantia Build system with clear area separation.",
      flow: "admin",
      audience: "admin",
      category: "Foundation",
      status: foundation.status,
