  ...
  const specs: RouteSpec[] = [
    {
      ...
      href: "/",
      title: "Home",
      purpose: "Public entry screen for the BuildFlow client journey.",
      flow: "client",
      audience: "public",
      category: "Foundation",
    ...
    },
    {
      ...
      href: "/dashboard",
      title: "Dashboard",
      purpose: "Signed-in command center for the active BuildFlow client journey.",
      flow: "client",
      audience: "signed_in",
      category: "Auth",
      status: auth.status,
    ...
    },
    {
      ...
      title: "Build Map",
      purpose: "Main clickable map of the BuildFlow system with clear area separation.",
      flow: "admin",
      audience: "admin",
      category: "Foundation",
      status: foundation.status,
