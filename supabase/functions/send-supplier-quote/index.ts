...
Deno.serve(async (request) => {
  ...
  if (action === "send_client_quote") {
    ...
    const text = [
      ...
      "The full branded quote is attached as a PDF.", "", "Avantia Build", companyEmail, "(516) 990-1990", "https://avantiabuild.com",
    ].join("\n")
