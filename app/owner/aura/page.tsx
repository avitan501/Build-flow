  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-6 text-slate-950 sm:px-8 sm:py-10">
      <section className="mx-auto max-w-7xl space-y-6">
        ...
        <AuraConnectionSetup whatsappReady={connections.whatsapp.send} whatsappProvider={connections.whatsapp.provider} whatsappHealth={connections.whatsapp.health} smsReady={connections.quo.send} smsReceiveReady={connections.quo.receive} />
