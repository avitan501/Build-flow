...
import { CREDIT_CARD_PROCESSING_TERM, PAYMENT_DISPUTE_TERM, RESTOCKING_TERM } from "@/lib/proposal-terms"
...
export default function TermsPage() {
  return <PolicyPage eyebrow="Website and requests" title="Terms of Use" updated="September 3, 2026" introduction="These terms apply to use of the Avantia Build website. A written quote, order confirmation, supplier term, or signed agreement may include additional terms for a specific transaction." sections={[
    ...
    { title: "Payment terms", paragraphs: [CREDIT_CARD_PROCESSING_TERM, PAYMENT_DISPUTE_TERM] },
    { title: "Returns and restocking", paragraphs: [RESTOCKING_TERM, "Nothing in this return policy limits rights for defective or materially nonconforming goods, or any other right protected by applicable law."] },
