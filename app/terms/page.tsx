...
export default function TermsPage() {
  return <PolicyPage eyebrow="Website and requests" title="Terms of Use" updated="August 14, 2026" introduction="These terms apply to use of the Avantia Build website. A written quote, order confirmation, supplier term, or signed agreement may include additional terms for a specific transaction." sections={[
