...
export default function ReturnsPage() {
  return <PolicyPage eyebrow="After delivery" title="Returns and Damaged Materials" updated="August 14, 2026" introduction="Return eligibility depends on the supplying store or manufacturer and the written terms confirmed before purchase." sections={[
    ...
    { title: "Fees and transportation", paragraphs: ["Approved returns may be subject to supplier restocking, pickup, freight, or handling charges. These amounts will be disclosed before the return is processed when available."] },
