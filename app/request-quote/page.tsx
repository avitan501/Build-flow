    ...
    <main className="min-h-screen bg-[#f5f7fa] pb-16 text-slate-950">
      <section className="border-b border-slate-200 bg-[#071126] px-5 py-8 text-white sm:px-8 sm:py-10">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-2 text-3xl font-semibold sm:text-4xl">Request a construction quote</h1>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-200 sm:text-base">Tell us about the project, materials, and timing. Our team will review the request and follow up with the right questions.</p>
        </div>
      </section>
