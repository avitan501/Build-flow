      ...
      <section className="mx-auto flex max-w-md flex-col gap-6 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/20">
        <div>
          ...
          <p className="mt-3 text-sm leading-6 text-slate-300">
            This screen is reserved for Supabase email/password signup. New users will start as Pending once auth is connected.
          </p>
        </div>

        <div className="rounded-2xl border border-dashed border-white/15 bg-slate-900/60 p-4 text-sm text-slate-300">
          Planned fields: full name, company, email, password, and auto-create profile with role client and approval status pending.
        </div>
