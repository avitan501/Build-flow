      ...
      <section className="mx-auto flex max-w-7xl flex-col gap-6">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-3xl">
              ...
              <div className="mt-5 rounded-3xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-900">
                ...
                <p className="mt-2 leading-6">This is the final client step after approval. Delivery tracking and status visibility should now be the focus.</p>
              </div>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5 sm:min-w-80">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">Final client page · no additional flow step</p>
            </div>
          </div>
        </section>
        ...
        <section className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-4 text-sm leading-6 text-slate-600">There is no additional flow step after this page. Clients can return to their projects if they need to review something else.</p>
            <div className="mt-5">
              <Link
                href="/projects"
