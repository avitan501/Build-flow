...
export default async function WebsiteDefectsPage() {
  ...
  return <main className="min-h-screen bg-[#f5f5f7] px-3 pb-20 pt-4 text-slate-950 sm:px-6 sm:pt-6"><div className="mx-auto max-w-6xl"><Link href="/admin/ai-tools" className="mb-4 inline-flex min-h-10 items-center gap-1 text-xs font-bold text-[#0066cc]"><ChevronLeft className="h-4 w-4" />Manager Tools</Link><WebsiteDefectInbox issues={issues} checks={checks} /></div></main>
}
