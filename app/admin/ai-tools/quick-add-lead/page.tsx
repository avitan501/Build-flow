...
export default async function QuickAddLeadPage() {
  ...
  return <main className="min-h-screen bg-[#f5f5f7] px-3 py-4 text-slate-950 sm:px-6 sm:py-6">
    <div className="mx-auto max-w-2xl">
      ...
      <header className="mb-5 mt-2"><p className="text-[10px] font-black uppercase tracking-[.16em] text-[#0066cc]">Mobile CRM</p><h1 className="mt-1 text-3xl font-black">Quick Add Lead</h1><p className="mt-2 text-sm leading-6 text-slate-600">Capture the contact and next step quickly. This creates a lead, not a client or order.</p></header>
      <MobileQuickAddLead />
    </div>
  </main>
}
