...
export default async function ManagerDocumentsPage({ searchParams }: { searchParams: Promise<{ intent?: string; department?: string; upload?: string }> }) {
  ...
  const initialDepartment = departments.find((department) => department === params.department) ?? "Others"
