  ...
  return (
    <main className="min-h-screen bg-[#f5f7fa] pb-16 text-slate-950">
      ...
      <div className="mx-auto max-w-5xl py-6 sm:px-6 sm:py-8">
        ...
        <p className="px-5 py-5 text-center text-xs text-slate-500">Need help now? Call <a href="tel:+15169901990" className="font-semibold text-[#0066cc]">(516) 990-1990</a>.</p>
      </div>
    </main>
  )
}
