...
export default function DemoClientFlowQuotePage() {
  return <ClientWireframePage pageKey="quotes" hrefMap={hrefMap} audienceLabel="Public Demo Client Flow" modeLabel="Demo mode · no login" />;
}
