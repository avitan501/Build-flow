...
export default function DemoClientFlowUploadPage() {
  return <ClientWireframePage pageKey="upload" hrefMap={hrefMap} audienceLabel="Public Demo Client Flow" modeLabel="Demo mode · no login" />;
}
