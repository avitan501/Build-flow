...
export default function DemoClientFlowOrdersPage() {
  return (
      ...
      <section className="mx-auto flex max-w-7xl flex-col gap-6">
        <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">Final Step: Track Your Order</h1>
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs font-semibold uppercase tracking-[0.16em]">
                <span className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-slate-700">Who this page is for: Public Demo Client Flow</span>
                <span className="rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-emerald-700">Current step: Track Your Order</span>
                <span className="rounded-full border border-sky-200 bg-sky-50 px-3 py-1 text-sky-700">Demo mode · no login</span>
              </div>
              <div className="mt-5 rounded-3xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-900">
                <div className="text-xs font-semibold uppercase tracking-[0.16em] text-emerald-700">Journey complete</div>
                <p className="mt-2 leading-6">This is the end of the public demo flow. The next action is only to return to the demo start.</p>
              </div>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5 sm:min-w-80">
              ...
              <div className="mt-3 text-2xl font-semibold text-slate-900">100% complete</div>
              <div className="mt-2 h-2 overflow-hidden rounded-full bg-white">
                <div className="h-full rounded-full bg-slate-900" style={{ width: "100%" }} />
              </div>
              <p className="mt-3 text-sm leading-6 text-slate-600">Final demo page · no further order step</p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">The client path ends here with delivery tracking context.</p>
          </div>
        ...
        <section className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-4 text-sm leading-6 text-slate-600">There is no additional order step after this screen.</p>
            <div className="mt-5">
              <Link
                href="/demo/client-flow"
