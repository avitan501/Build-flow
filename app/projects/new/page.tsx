      ...
      <section className="mx-auto max-w-2xl">
        <form action={createProjectAction} className="rounded-[28px] border border-sky-100 bg-white p-5 shadow-[0_18px_42px_rgba(148,163,184,0.12)] sm:p-7">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            ...
            <Link href="/projects" className="inline-flex min-h-12 items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition active:scale-[0.99]">
              Cancel
            </Link>
          </div>
        </form>
